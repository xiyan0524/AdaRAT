...
parser = argparse.ArgumentParser(description='Dynamic AT')
...
parser.add_argument('--FOSC_control_epoch', default=60, type=int, help='FOSC control epoch')
parser.add_argument('--FOSC_max', default=0.3, type=float, help='max FOSC')
...
if __name__ == "__main__":
    ...
    for epoch in range(0, args.epoch):
        ...
        fosc = np.max([0, args.FOSC_max - args.FOSC_max * (epoch * 1.0 / args.FOSC_control_epoch)])
        ...
        for i, data in enumerate(train_loader, 0):
            ...
            perturbed_inputs = train_attack.attack_fosc(inputs, labels, fosc)
