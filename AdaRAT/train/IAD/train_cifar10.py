...
parser.add_argument('--up_lim', default=0.8, type=float, help='up limit')
parser.add_argument('--down_lim', default=0.2, type=float, help='down limit')
...
teacher_robust = resnet.ResNet18(args.class_num).to(device)
teacher_standard = resnet.ResNet18(args.class_num).to(device)
teacher_robust.load_state_dict(torch.load("../../result/cifar10/save_model/" + args.teacher_robust_name))
teacher_standard.load_state_dict(torch.load("../../result/cifar10/save_model/" + args.teacher_standard_name))
